...
public class DeleteCoustomer extends JFrame implements ActionListener {
    JButton b1,b2;
    String username;
    DeleteCoustomer(String user)
    {
        this.username = user;
       ...
       heading.setBounds(110,10,300,25);
       ...
       l8.setBounds(30,390,100,16);
       add(l8);
       
        JLabel l18= new JLabel();
       l18.setBounds(250,390,200,16);
       add(l18);
       
       JLabel l9 = new JLabel("email");
       l9.setBounds(30,350,100,16);
       add(l9);
       
        JLabel l19= new JLabel();
       l19.setBounds(250,350,200,16);
       add(l19);
       ...
       public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1)
        {
            try{
                ...
                c.s.executeUpdate("delete from bookhotell where username = '"+username+"'");
    ...
    {
        new DeleteCoustomer("").setVisible(true);
    }
}
